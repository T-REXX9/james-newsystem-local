          ...
          <div className="mx-auto flex max-w-[1500px] flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <h1 className="text-2xl font-extrabold uppercase tracking-tight text-[#173c83]">Create Purchase Request</h1>
