                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="mt-2 flex items-center justify-between text-xs">
                                            <span className="text-slate-500">{rr.status === 'Posted' ? 'Received' : rr.status === 'Cancelled' ? 'Cancelled' : 'Expected'}: {new Date(rr.receive_date).toLocaleDateString('en-PH', { month: 'short', day: '2-digit', year: '2-digit' }).replace(/ /g, '\u2011').replace(',', '').toUpperCase()}</span>
