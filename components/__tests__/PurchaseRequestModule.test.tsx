...
vi.mock('../PurchaseRequest/PurchaseRequestList', () => ({ default: ({ onCreate, onSelect }: { onCreate: () => void; onSelect: (request: unknown) => void }) => <div><button type="button" onClick={onCreate}>New PR</button><button type="button" onClick={() => onSelect({ id: 'PRREF-1', pr_number: 'PR-2601' })}>Select PR</button></div> }));
