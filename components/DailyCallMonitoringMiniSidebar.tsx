...
const DailyCallMonitoringMiniSidebar: React.FC<DailyCallMonitoringMiniSidebarProps> = ({
  ...
  return (
    <nav
      ...
      className="w-full rounded-xl border border-slate-200 bg-white p-2 shadow-sm dark:border-slate-700 dark:bg-slate-900 lg:sticky lg:top-4 lg:w-40 lg:shrink-0 lg:self-start 2xl:w-48 2xl:p-3"
    >
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex min-w-[130px] items-center gap-2 rounded-lg px-2.5 py-2 text-xs font-semibold transition lg:min-w-0 2xl:min-h-12 2xl:px-3 2xl:text-sm ${
                isActive
